...
![빌드게시판](src/main/webapp/resources/readme/빌드%20게시판.png) <br/>
1. 빌드 게시판(사진 수정필요) <br/>
   1).            <br/>
   2).            <br/>
   3).            <br/>
...
2. 게시글 상세보기 1 <br/>
   ...
   4). 마크다운 뷰어를 이용해 게시글에 사진이 들어있으면 이미지를 표현해줌 <br/>
...
3. 게시글 상세보기 2 <br/>
   1). 게시글 추천과 비추천 버튼(한번 누른사람은 중복추천이나 중복비추천을 할 수 없음) <br/>
   2). 댓글 등록 화면 <br/>
   3). 댓글이 달리면 화면에 댓글이 달리고 댓글 작성자라면 해당 댓글에 삭제버튼이 나옴 <br/>

<br/>
<br/>

![게시글작성_1](src/main/webapp/resources/readme/자유게시판_게시글작성_1.png) <br/>
4. 게시글 작성 1 <br/>
   1). 마크다운 에디터를 사용한 게시글 작성 <br/>
<br/>

![게시글작성_2](src/main/webapp/resources/readme/자유게시판_게시글작성_2.png)<br/>
5. 게시글 작성 2 <br/>
   1). 카테고리별 클릭시 ajax를 활용한 화면 표출 <br/>
   2). 해당 카테고리를 클릭시 db에 있는 정보들을 가져와 보여줌 <br/>
   3). 가져와진 이미지들을 클릭시 마크다운에 올라가서 게시글 작성에 사용할 수 있음. <br/>
   4). 작성을 시작하면 게시글 작성 칸이 두개로 나누어져 작성과 프리뷰를 함께 볼 수 있음 <br/>
<br/>
<br/>

--------------------------------------------------------------------- 패치 게시판 -------------------------------------------------------------------------

![패치게시판](src/main/webapp/resources/readme/패치게시판_1.png) <br/>
1. 패치게시판 <br/>
   1).       <br/>
   2).       <br/>
   3).       <br/>
...
![게시글보기_1](src/main/webapp/resources/readme/패치게시판게시글보기_1.png) <br/>
2. 게시글 보기 1 <br/>
   1).       <br/>
   2).       <br/>
   3).       <br/>
...
![게시글보기_2](src/main/webapp/resources/readme/패치게시판게시글보기_2.png) <br/>
3. 게시글 보기 2 <br/>
   1).        <br/>
   2).        <br/>
   3).        <br/>
...
![게시글작성](src/main/webapp/resources/readme/패치게시판게시글작성.png) <br/>
4. 게시글 작성 <br/>
   1).        <br/>
   2).        <br/>
   3).        <br/>
...
![로그인](src/main/webapp/resources/readme/로그인페이지.png) <br/>
1. 로그인 <br/>
   1).        <br/>
   2).        <br/>
   3).        <br/>
...
![비밀번호찾기](src/main/webapp/resources/readme/이메일%20비번초기화.png) <br/>
2. 비밀번호 찾기 <br/>
   1).       <br/>
   2).       <br/>
   3).       <br/>
...
![이메일회원가입](src/main/webapp/resources/readme/이메일%20회원가입.png) <br/>
3. 이베일 회원가입 <br/>
   1).       <br/>
   2).       <br/>
   3).       <br/>
...
![마이페이지](src/main/webapp/resources/readme/마이페이지.png) <br/>
1. 마이페이지 <br/>
   1).       <br/>
   2).       <br/>
   3).       <br/>
