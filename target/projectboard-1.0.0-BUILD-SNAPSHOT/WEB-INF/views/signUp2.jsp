	...
	<div>
		<div id="logo">
	 	...
	 	<div id="reset-container">
		   	<h2>이메일 회원가입</h2>
		   	<p>PS Member회원가입 요청이 완료되었습니다.<br/>메일을 확인해주세요.</p>
			<p>회원가입 메일에 포함된 링크를 클릭하시고, 로그인을 진행해주세요.</p>
			<p>*계정 인증 메일이 오지 않는다면 스팸 혹은 프로모션 메일함을 확인해<br/>주세요</p>		   	
		    <form>
		      <button type="submit" id="button1">메일 재발송</button>
		      <button type="submit" id="button2">홈으로 이동</button>
		    </form>
		</div>
	</div>
</body>
