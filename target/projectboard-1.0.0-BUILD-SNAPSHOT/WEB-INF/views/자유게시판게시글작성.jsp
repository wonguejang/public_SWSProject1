...
<body style = "width : 1920px;">
	<div class = "header_div">
		<div class = "header_inner">
			...
			<div>
				<c:choose>
					<c:when test = "${empty sessionScope.id}">	<!-- 세션에 아이디가 있는지 확인 -->
	...
	<script>
		const editor = new toastui.Editor({
		    ...
		    customHTMLSanitizer: html => html // ← 이거 반드시 있어야 함
		});
		// 이미지 클릭시 게시글 작성중인 내용에 이미지 넣어주기
		...
		$('#submitBtn').on('click', function(e){
        	...
        	console.log("에디터 내용 content : "+content);
        	
        	$.ajax({
        		type : 'post',
        		url : 'BoardWriteAction',
