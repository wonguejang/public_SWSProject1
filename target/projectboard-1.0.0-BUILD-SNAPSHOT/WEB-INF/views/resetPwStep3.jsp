...
<head>
  ...
  <style>
    * {
    ...
    #new_password, #okay_new_password {
	    padding-top: 8px;
	    padding-bottom: 8px;
	    border-radius: 8px;
	    border: none;
		...
		<div id="logo">
	 	...
	 	<div id="reset-container">
	     	...
	     	<div>
		      ...
		      <p id="content1">새로운 비밀번호</p>
		      <input type="password" id="new_password" name="newPassword" required>
		      <p id="content2">새로운 비밀번호 확인</p>
		      <input type="password" id="okay_new_password" name="confirmPassword" required>
		      <button type="submit" id="reset-button">비밀번호 초기화</button>
		      </form>
			</div>
		</div>
	</div>
